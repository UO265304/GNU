...
class Tx_qpsk(gr.top_block, Qt.QWidget):

    def __init__(self, frame_size=60, hdr_const=digital.constellation_calcdist((digital.psk_2()[0]), (digital.psk_2()[1]), 2, 1).base(), hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0,2)):
        gr.top_block.__init__(self, "Tx_qpsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tx_qpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Tx_qpsk")
        ...
        # Blocks
        ##################################################
        self._gain_tx_range = Range(0, 100, 1, 30, 200)
        self._gain_tx_win = RangeWidget(self._gain_tx_range, self.set_gain_tx, 'Gain', "counter_slider", float)
        self.top_grid_layout.addWidget(self._gain_tx_win, 0, 0, 1, 2)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_0_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_diff_encoder_bb_0_0_0 = digital.diff_encoder_bb(len(pld_const.points()))
        self.digital_crc32_bb_1_0 = digital.crc32_bb(False, "packet_len", True)
        ...
        self.digital_burst_shaper_xx_0 = digital.burst_shaper_cc(firdes.window(firdes.WIN_HANN, 50, 0), 10, 10, True, "packet_len")
        ...
        self.blocks_repack_bits_bb_0_1 = blocks.repack_bits_bb(8, hdr_const.bits_per_symbol(), 'packet_len', False, gr.GR_MSB_FIRST)
        self.blocks_repack_bits_bb_0_0_1 = blocks.repack_bits_bb(8, pld_const.bits_per_symbol(), 'packet_len', False, gr.GR_MSB_FIRST)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(0.6)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\usuario\\Downloads\\montanas-rocosas-canada-650x367.jpg', False, 0, 0)
        ...
        self.connect((self.blocks_repack_bits_bb_0_0_1, 0), (self.digital_diff_encoder_bb_0_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_0_1, 0), (self.digital_diff_encoder_bb_0_1, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0_0, 0), (self.digital_crc32_bb_1_0, 0))
        self.connect((self.blocks_tagged_stream_multiply_length_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0_0, 0), (self.digital_burst_shaper_xx_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        ...
        self.connect((self.digital_crc32_bb_1_0, 0), (self.blocks_repack_bits_bb_0_0_1, 0))
        self.connect((self.digital_crc32_bb_1_0, 0), (self.digital_protocol_formatter_bb_0_0, 0))
        ...
        self.connect((self.digital_protocol_formatter_bb_0_0, 0), (self.blocks_repack_bits_bb_0_1, 0))
        self.connect((self.pfb_arb_resampler_xxx_0_0, 0), (self.blocks_tagged_stream_multiply_length_0_0, 0))
...
def main(top_block_cls=Tx_qpsk, options=None):
    if options is None:
