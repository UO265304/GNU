...
class Rx_qpsk(gr.top_block, Qt.QWidget):

    def __init__(self, frame_size=60, hdr_const=digital.constellation_calcdist((digital.psk_2()[0]), (digital.psk_2()[1]), 2, 1).base(), hdr_dec= fec.dummy_decoder.make(8000), hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0,2)):
        gr.top_block.__init__(self, "Rx_qpsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx_qpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Rx_qpsk")
        ...
        self.digital_crc32_bb_0 = digital.crc32_bb(True, "payload symbols", True)
        self.digital_costas_loop_cc_0_0_0 = digital.costas_loop_cc(6.28/100, pld_const.arity(), False)
        self.digital_costas_loop_cc_0_0 = digital.costas_loop_cc(3.14/100, hdr_const.arity(), False)
        ...
        self.digital_constellation_decoder_cb_0_0 = digital.constellation_decoder_cb(pld_const.base())
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(12)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/pi/Desktop/GNU RADIO CARLOS/prueba.jpg', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0_1, 0), (self.digital_crc32_bb_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0_0_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
...
def main(top_block_cls=Rx_qpsk, options=None):
    if options is None:
